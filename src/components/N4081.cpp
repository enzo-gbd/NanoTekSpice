...
using N4081 = nts::component::primitive::N4081;
...
void N4081::simulate(std::size_t tick)
{

}

nts::Tristate N4081::compute(std::size_t pin)
{
    return nts::Tristate::UNDEFINED;
}

void N4081::setLink(std::size_t pin, nts::IComponent &other, std::size_t otherPin)
{
    this->getPin(pin, nts::IO::OUTPUT).link = new nts::pin_t(other.getPin(otherPin, nts::IO::INPUT));
}

nts::pin_t &N4081::getPin(id_t id, IO IO_pin)
{
    if (id < 0 || id > 13 || id == 7) {
